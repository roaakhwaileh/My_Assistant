                    ...
                    <div class="tabs-animation">
                        <div class="card mb-3">
                            <div class="card-header-tab card-header">
                                ...
                                <?php print "View Image Slider In My Assistant"; ?>
                                </div>
                            </div>
                            <div class="card-body">
                         ...
                         <?php
                               ...
                               echo ("<tr>");
                               $id = $row['image_id'];
                               echo'<td scope="row"> <img src="'.$row["image_url"].'" width=18%; hight=18%;> </td>';
                               echo ('<td>'.$row['status'].' </td>');
                               echo ('<td>'.$row['added_date'].' </td>');
                               echo ('<td><a class="btn btn-primary" href="'.$row['redirect_url'].'" target="_blank" >View</a></td>');
                               echo ('<td><a class="btn btn-success" href="https://myassistant.jaml46.net/dashboard/pages/system/active_image_slider?id='.$row['image_id'].'&status='.$status1.'">Active</a><a class="btn btn-danger" href="https://myassistant.jaml46.net/dashboard/pages/system/active_image_slider?id='.$row['image_id'].'&status='.$status2.'">Inactive</a></td>');
     ...
     function deleteAlert(id)
        {
           Swal.fire({
                      ...
                      {
                          $.ajax({
                                url:"https://myassistant.jaml46.net/dashboard/pages/system/delete_home_slider?id="+id,
                                method:"post",
                                dataType:"text",
                                ...
                                { 
                                   ...
                                   if(data == "yes")
                                   {
                                        Swal.fire({
                                          ...
                                          if (result.isConfirmed) {
                                            window.open("https://myassistant.jaml46.net/dashboard/pages/people/view_Manage_slider","_self");        
                                          }
                                        })
