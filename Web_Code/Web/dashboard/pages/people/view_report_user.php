                    ...
                    <div class="tabs-animation">
                        <div class="card mb-3">
                            <div class="card-header-tab card-header">
                                ...
                                <?php print "User Report In My Assistant"; ?>
                                </div>
                            </div>
                            <div class="card-body">
                                <table style="width: 100%;" id="example" class="table table-hover table-striped table-bordered">
                                    ...
                                    <tbody>
                                       <?php
                                            $sql = "SELECT a.*,b.fullname FROM report a INNER JOIN user b ON (a.user_id=b.user_id) WHERE a.user_id != '-1'";
