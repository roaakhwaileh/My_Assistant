...
public class orderHistoryDetails extends AppCompatActivity {
    ...
    public  void sendreport(TextInputEditText text){
        ...
        String url = "https://myassistant.jaml46.net/APIs/assistant/add_report?assistant_id="+assistant_id+"&user_id="+sharedpreferences.getString("userid","")+"&text="+text.getText().toString();
