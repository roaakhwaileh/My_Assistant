...
public class orderhistoryitemmodel {
    ...
    public orderhistoryitemmodel(String req_assistant_id, String assistant_id, String description, String whatsapp_phone, String location, String status, String specialty_id, String hourly_work_id, String user_name, String assistant_name, String specialty_name) {
        this.req_assistant_id = req_assistant_id;
        this.assistant_id = assistant_id;
        this.description = description;
        this.whatsapp_phone = whatsapp_phone;
