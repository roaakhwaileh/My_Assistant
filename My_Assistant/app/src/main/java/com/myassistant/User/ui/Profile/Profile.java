package com.myassistant.User.ui.Profile;
...
import com.myassistant.User.EditProfile;
import com.myassistant.User.Login;
...
public class Profile extends Fragment {
    ...
    private void deleteaccount()
    {
        ...
        String url = "https://myassistant.jaml46.net/APIs/user/delete_user?user_id="+sharedpreferences.getString("userid","");;
    ...
    private void getInfo()
    {
        ...
        // Create a String request
        // using Volley Library
        String url = "https://myassistant.jaml46.net/APIs/user/get_info?user_id="+sharedpreferences.getString("userid","");;
    ...
    @Override
    public void onStart() {
        sharedpreferences = getActivity().getSharedPreferences("User_Id", Context.MODE_PRIVATE);
