...
public class EditProfile extends AppCompatActivity implements DatePickerDialog.OnDateSetListener {
    ...
    private void updateimage(String image) {
        ...
        String url = "https://myassistant.jaml46.net/APIs/assistant/update_image";
        ...
        StringRequest request = new StringRequest(Request.Method.POST, url, new com.android.volley.Response.Listener<String>() {
            ...
            protected Map<String, String> getParams() {
                ...
                params.put("assistant_id", sharedpreferences.getString("assistantid",""));
    ...
    private void updateinfo()
    {
        ...
        String url = "https://myassistant.jaml46.net/APIs/assistant/update_info?assistant_id="+sharedpreferences.getString("assistantid","")+"&fullname="+name.getText()+"&email="+email.getText()+"&phone="+phone.getText()+"&birthdate="+birthdate.getText()+"&gender="+gender.getText();
