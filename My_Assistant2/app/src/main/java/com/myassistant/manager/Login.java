...
public class Login extends AppCompatActivity {
    ...
    private void fetchdata()
    {
        ...
        String url = "https://myassistant.jaml46.net/APIs/assistant/login?email="+email.getText() + "&password="+password.getText();
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response)
                    {
                        ...
                        try {
                           ...
                           String id = jsonObject.get("assistant_id").toString();
                                ...
                                new AlertDialog.Builder(Login.this)
                                        ...
                                        .setPositiveButton("Complete", new DialogInterface.OnClickListener() {
                                            public void onClick(DialogInterface dialog, int which) {
                                                SharedPreferences sharedpreferences = getSharedPreferences("Assistant_Id", Context.MODE_PRIVATE);
                                                SharedPreferences.Editor editor = sharedpreferences.edit();
                                                editor.putString("assistantid", id);
                                                editor.commit();
                                                Intent intent=new Intent(Login.this,HomeActivity.class);
                                                intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK);
                                                intent.putExtra("assistant_id",id);
                                                startActivity(intent);
                                            }
                                        })
